package com.banyumas.wisata.feature.resetpassword
...
fun ResetPasswordScreen(
    ...
    var isLoading = resetPasswordState is com.banyumas.wisata.core.common.UiState.Loading
    ...
    LaunchedEffect(resetPasswordState) {
        when (val state = resetPasswordState) {
            is com.banyumas.wisata.core.common.UiState.Loading -> isLoading = true
