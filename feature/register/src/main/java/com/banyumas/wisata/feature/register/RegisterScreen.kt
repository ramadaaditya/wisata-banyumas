package com.banyumas.wisata.feature.register
...
fun RegisterScreen(
    ...
    val isLoading = authState is com.banyumas.wisata.core.common.UiState.Loading
...
private fun RegisterContent(
    ...
    Column(
        ...
        com.banyumas.wisata.core.designsystem.components.UsernameInputField(
            value = username,
            onValueChange = onUsernameChange
        )
        Spacer(modifier = Modifier.height(8.dp))
        com.banyumas.wisata.core.designsystem.components.EmailInputField(
            value = email,
            onValueChange = onEmailChange
        )
        Spacer(modifier = Modifier.height(8.dp))
        com.banyumas.wisata.core.designsystem.components.PasswordInputField(
            value = password,
