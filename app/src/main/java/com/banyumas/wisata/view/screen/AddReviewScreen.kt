...
fun AddReviewScreen(
    ...
    Column(
        ...
        Text(text = "Tambahkan Review", style = AppTheme.typography.titleMedium)
            ...
            onClick = {
                if (rating > 0 && reviewText.isNotBlank()) {
                    coroutineScope.launch {
                        try {
                            // Panggil fungsi addReview di ViewModel
                            // authorName bisa "Guest" atau sesuai logic Anda
                            ...
                            Toast.makeText(context, "Gagal menambahkan review", Toast.LENGTH_SHORT)
                                .show()
                        }
                    }
                } else {
                    Toast.makeText(context, "Harap isi rating dan ulasan!", Toast.LENGTH_SHORT)
                        .show()
                }
            },
            text = "Kirim Review"
